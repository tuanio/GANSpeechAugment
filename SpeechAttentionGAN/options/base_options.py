...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="audio",
            help="chooses how datasets are loaded. [unaligned | audio]",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            type=int,
            default=256,
            help="scale images(height) to this size",
        )
        parser.add_argument(
            "--load_size_w",
            type=int,
            default=256,
            help="scale images(width) to this size",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            help="Method to load spectrograms from different domains.",
        )
        parser.add_argument(
            "--use_mask", action="store_true", help="Mask inputs when training."
        )
        parser.add_argument(
            "--max_mask_len",
            type=int,
            default=25,
            help="Max length of mask if --use_mask option is used.",
        )
        parser.add_argument(
            "--use_phase", action="store_true", help="Use phase spectogram in model."
        )
        ...
        parser.add_argument(
            "--single_direction",
            action="store_true",
            help="Only clean data is present.Use only for test.",
        )
